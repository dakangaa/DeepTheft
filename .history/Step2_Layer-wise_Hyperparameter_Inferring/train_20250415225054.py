...
def eval_step(epoch, arg, loader):
    ...
    print(logs.format(arg, epoch, eval_loss / len(loader), accuracy / len(loader), p / len(loader), r / len(loader), F1 / len(loader)))
    return eval_loss / len(loader), accuracy / len(loader), F1 / len(loader)
