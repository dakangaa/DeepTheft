...
if __name__ == "__main__":
    ...
    if args.mode == "O":
        ...
        with pd.ExcelWriter("results/results.xlsx", if_sheet_exists="replace", mode="a") as writer:
            if args.regression:
                df.to_excel(writer, sheet_name=args.layer_type +"_"+ "origin_domain_num_regression")
            else:
                df.to_excel(writer, sheet_name=args.layer_type +"_"+ "origin_domain_num")
    elif args.mode == "T":
        ...
        with pd.ExcelWriter("results/results.xlsx", if_sheet_exists="replace", mode="a") as writer:
            if args.regression:
                df.to_excel(writer, sheet_name=args.layer_type +"_"+ "test_domain_regression")
            else:
                df.to_excel(writer, sheet_name=args.layer_type +"_"+ "test_domain")
    else:
        raise ValueError
