...
def eval(epoch, args, loader, prototypes):
    ...
    print(logs.format(args.mode, epoch, metrics[0], metrics[1], metrics[2], metrics[3]))
    return metrics[3]
...
print("Loading data...")
data = dataset.RaplLoader(args, input_size = [args.test_domain], no_val=True, data_ratio=1.0)
